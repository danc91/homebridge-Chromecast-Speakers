...
ControlChromecastPlatform.prototype.scanAccesories = function () {
  ...
  let addChromecast = function(device){
    if(device && device.txtRecord && ['Chromecast','Chromecast Ultra', 'Nest WiFi Point','Nest WiFi Router','Chromecast Audio', 'Google Cast Group', 'JBL Link View', 'Lenovo Smart Display', 'Google Nest Hub', 'Lenovo Smart Clock', 'Google Home', 'Google Home Mini', 'Google Nest Hub Max'].indexOf(device.txtRecord.md) !== -1){
